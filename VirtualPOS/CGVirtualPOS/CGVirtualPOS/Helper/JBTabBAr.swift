...
public class JBTabBar: UITabBar {
    ...
    func setupTabBar() {
        ...
        tabBarCurveShapeLayer.fillColor = UIColor.init(red: 0.0/255.0, green: 126.0/255.0, blue: 229.0/255.0, alpha: 1.0).cgColor
        tabBarCurveShapeLayer.strokeColor = UIColor.clear.cgColor
        tabBarCurveShapeLayer.path = createPathForTabBar().cgPath
        self.layer.insertSublayer(tabBarCurveShapeLayer, at: 0)
        self.backgroundColor = UIColor.init(red: 0.0/255.0, green: 126.0/255.0, blue: 229.0/255.0, alpha: 1.0)
        self.backgroundImage = UIImage(named: "ic_blue_bar")
