...
public extension UIView {
    ...
    public func addVisualEffect() {
        ...
        blur.alpha = 0.99
        //        let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(FlagContent.handleTapGesture(_:)))
        //        blur.addGestureRecognizer(tapGestureRecognizer)
        self.insertSubview(blur, at: 0)
    }
    
    
    public func addShadow(_ shadowRadius: CGFloat = 2.0, shadowOpacity: Float = 0.2) {
    ...
    public func addShadoww(offset: CGSize, color: UIColor, radius: CGFloat, opacity: Float) {
    ...
    public func addShadowAgain(_ shadowRadius: CGFloat = 2.0, shadowOpacity: Float = 0.2) {
        self.layer.masksToBounds = false
    ...
    //    public func addShadow(ofColor color: UIColor = UIColor.black,
    //                          radius: CGFloat = 3,
    ...
    func insertShadow(shadowRadius: CGFloat = 5.0, width: CGFloat = 0.0, height: CGFloat = 0.0, shadowOpacity: Float = 0.4, shadowColor: UIColor = UIColor.lightGray) {
        layer.masksToBounds = false
    ...
    /**
     Use this method to set Visual Format Constarints
    ...
    func addConstraintWithFormat(format : String, views: UIView...)
    {
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: format, options: NSLayoutConstraint.FormatOptions(), metrics: nil, views: dict))
    }
}
...
extension Notification.Name{
    ...
    static let setInvoiceListSelected                    = Notification.Name(rawValue: "setInvoiceListSelected")
